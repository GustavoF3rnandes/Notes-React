...
import { NewNoteCard } from "./componets/new-node-card";
    ...
    <div className="mx-auto max-w-6xl my-12 space-y-6 px-5 ">
      <form className="w-full">
        <input 
          ...
          className="w-full bg bg-transparent txt-3xl font-semibold tracking-tight outline-none placeholder:text-slate-500"
